...
exports.TextToSpeechAsyncRequest = void 0;
const core = __importStar(require("../../../../../core"));
exports.TextToSpeechAsyncRequest = core.serialization.object({
    ...
    webhookReceiver: core.serialization.property("webhook_receiver", core.serialization.string().optional()),
    usersWebhookParameters: core.serialization.property("users_webhook_parameters", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optional()),
    ...
    option: core.serialization
        .lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../../..")))).TextToSpeechAsyncRequestOption; }))
        .optional(),
