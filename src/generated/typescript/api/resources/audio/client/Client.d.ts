...
export declare class Audio {
     ...
     */
    speechToTextAsyncRetrieve(requestOptions?: Audio.RequestOptions): Promise<EdenAi.ListAsyncJobResponse>;
    /**
     ...
     * </details>
     */
    speechToTextAsyncCreate(file: File | fs.ReadStream, request: EdenAi.SpeechToTextAsyncRequest, requestOptions?: Audio.RequestOptions): Promise<EdenAi.LaunchAsyncJobResponse>;
    /**
     ...
     */
    speechToTextAsyncRetrieve2(publicId: string, request?: EdenAi.AudioSpeechToTextAsyncRetrieve2Request, requestOptions?: Audio.RequestOptions): Promise<EdenAi.AsyncaudiospeechToTextAsyncResponseModel>;
    /**
     * <details><summary><strong style='color: #0072a3; cursor: pointer'>Available Providers</strong></summary>
     *
     *
     ...
     * @throws {@link EdenAi.InternalServerError}
     */
    textToSpeechCreate(request: EdenAi.AudiotextToSpeechTextToSpeechRequest, requestOptions?: Audio.RequestOptions): Promise<EdenAi.AudiotextToSpeechResponseModel>;
    /**
     * Get a list of all jobs launched for this feature. You'll then be able to use the ID of each one to get its status and results.<br>
     *                         Please note that a **job status doesn't get updated until a get request** is sent.
     */
    textToSpeechAsyncRetrieve(requestOptions?: Audio.RequestOptions): Promise<EdenAi.ListAsyncJobResponse>;
    /**
     ...
     * </details>
     */
    textToSpeechAsyncCreate(request: EdenAi.TextToSpeechAsyncRequest, requestOptions?: Audio.RequestOptions): Promise<EdenAi.LaunchAsyncJobResponse>;
    /**
     * Get the status and results of an async job given its ID.
     * @throws {@link EdenAi.BadRequestError}
     * @throws {@link EdenAi.ForbiddenError}
     ...
     * @throws {@link EdenAi.InternalServerError}
     */
    textToSpeechAsyncRetrieve2(publicId: string, request?: EdenAi.AudioTextToSpeechAsyncRetrieve2Request, requestOptions?: Audio.RequestOptions): Promise<EdenAi.AsyncaudiotextToSpeechAsyncResponseModel>;
