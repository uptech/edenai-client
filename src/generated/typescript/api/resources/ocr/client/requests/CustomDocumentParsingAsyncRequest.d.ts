...
export interface CustomDocumentParsingAsyncRequest {
    ...
    fileUrl?: string;
    /** Your queries need to be a list of dict containing the questions you want answered and the page to look for the information in :  '[{'query':'your query','pages':'your pages'},{'query':'your query','pages':'your pages'}]' <span style="white-space: nowrap">`non-empty`</span> */
    queries: string;
}
