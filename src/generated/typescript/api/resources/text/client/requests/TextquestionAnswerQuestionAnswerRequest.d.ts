...
export interface TextquestionAnswerQuestionAnswerRequest {
    ...
    texts: string[];
    /** Question about the text content <span style="white-space: nowrap">`non-empty`</span> */
    question: string;
    ...
    temperature?: number;
    /** example text serving as context <span style="white-space: nowrap">`non-empty`</span> */
